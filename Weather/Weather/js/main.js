...
function loadWeather() {
    ...
    if(city === ''){city = "Izmir"}
    var conditionsPath = "http://api.wunderground.com/api/[api_key]/conditions/q/Turkey/"+city+".json";
    var forecastPath = "http://api.wunderground.com/api/[api_key]/forecast/q/Turkey/"+city+".json";
